...
module.exports = function socket (socket) {
  ...
  } else if (socket.request.session.ssh.username && socket.request.session.ssh.password && socket.request.session.ssh) {
    // console.log('hostkeys: ' + hostkeys[0].[0])
    conn.connect({
      host: socket.request.session.ssh.host,
      port: socket.request.session.ssh.port,
      username: socket.request.session.ssh.username,
      password: socket.request.session.ssh.password,
      tryKeyboard: true,
      algorithms: socket.request.session.ssh.algorithms,
      readyTimeout: socket.request.session.ssh.readyTimeout,
      keepaliveInterval: socket.request.session.ssh.keepaliveInterval,
  ...
  } else if (socket.request.session.ssh.username && socket.request.session.ssh.privateKey && socket.request.session.ssh) {// 通过密钥连接服务器
    conn.connect({ 
      host: socket.request.session.ssh.host,
      port: socket.request.session.ssh.port,
      username: socket.request.session.ssh.username,
      privateKey: require('fs').readFileSync(socket.request.session.ssh.privateKey),//密钥文件地址
      tryKeyboard: true,
      algorithms: socket.request.session.ssh.algorithms,
      readyTimeout: socket.request.session.ssh.readyTimeout,
      keepaliveInterval: socket.request.session.ssh.keepaliveInterval,
